...
import { renderLiveStats } from './liveStats';
 ...
 * and states the license and the AI-assistance disclosure on every page. When
 * live statistics are on, it also carries the (initially hidden) live line
 * for `currentPath` (ADR 0022).
 */
...
${renderLiveStats(config, currentPath)}
